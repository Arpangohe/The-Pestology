...
translations = {
    ...
    hi:{
      ...
      services: "सेवाएं",
      contacth: "संपर्क करें",
    // <!-- Service Hero Section -->
    Termite_Controlh:"दीमक नियंत्रण सेवाएं",
    Termite_Controlp:"दीमक से सुरक्षा के लिए भरोसेमंद और असरदार उपचार सेवाएं।",
    // <!-- Service Details -->
    Termite_Protectionh:"दीमक से पूरी सुरक्षा के समाधान",
    Termite_Protectionp:"हमारी आधुनिक दीमक नियंत्रण सेवाएं दीमकों को खत्म करने और आपकी संपत्ति को लंबे समय तक सुरक्षित रखने में मदद करती हैं। हम नई तकनीकों और पर्यावरण के अनुकूल उपायों से आपके घर या व्यवसाय को दीमक से बचाते हैं।",
    // <!-- Pre-Construction Anti-Termite Treatment -->
    Anti_Termiteh:"निर्माण से पहले दीमक से सुरक्षा का उपचार",
    Anti_Termitehp:"अपने नवनिर्माण को दीमकों से सुरक्षा दें, वह भी नींव चरण से ही। हमारा निर्माण पूर्व उपचार रासायनिक अवरोध उत्पन्न करता है, जो दीमकों के प्रवेश को रोकता है।",
    price_tag:"₹12 प्रति वर्ग फीट से शुरू।",
    servicel1:"नींव डालने से पहले सम्पूर्ण मिट्टी का उपचार",
    servicel2:"नींव और जोड़ वाले स्थानों का उपचार",
    servicel3:"लंबे समय तक प्रभावी दीमकनाशी दवाओं का प्रयोग",
    servicel4:"उपचार के साथ 5 साल की गारंटी",
    servicel5:"प्रमाणित एवं अनुभवी विशेषज्ञ",
    WhatsApp:"व्हाट्सएप पर अनुमान प्राप्त करें",
    // <!-- Post-Construction Termite Treatment -->
    Post_Consth:"निर्माण के बाद दीमक उपचार",
    Post_Consthp:"अगर आपकी मौजूदा संपत्ति दीमक समस्या से प्रभावित है, तो हमारा निर्माण के बाद का उपचार सक्रिय कॉलोनियों को नष्ट करता है और भविष्य में होने वाले नुकसान से बचाता है।",
    post_servicel1:"दीमक के प्रवेश स्थानों और नुकसान का पता लगाने के लिए विस्तृत निरीक्षण",
    post_servicel2:"प्रभावित स्थानों में दीमकनाशक का ड्रिल और इंजेक्शन",
    post_servicel3:"इमारत के चारों ओर खुदाई उपचार",
    post_servicel4:"लकड़ी के ढांचों और फर्नीचर का उपचार",
    post_servicel5:"3 वर्ष की सेवा गारंटी, साथ में हर साल निरीक्षण",
    // <!-- Termite Baiting System -->
    Termiteh:"दीमक नियंत्रण प्रणाली",
    Termitehp:"हमारा तरीका दीमक की आदतों का इस्तेमाल करता है, जिससे बिना ज्यादा रसायन के पूरी दीमक नष्ट हो जाती है।",
    price:"रहायशी स्थापना के लिए ₹25,000 से शुरू",
    Termite_servicel1:"आपकी संपत्ति के आसपास निगरानी जगहों की स्थापना",
    Termite_servicel2:"दीमक गतिविधि पहचानने के लिए लकड़ी आधारित जांच उपकरण का उपयोग",
    Termite_servicel3:"दीमक का पता चलने पर उपकरण को सक्रिय प्रलोभन से बदलना",
    Termite_servicel4:"दीमक की भोजन आदतों से दीमक का नाश करना",
    Termite_servicel5:"प्रलोभन स्थानों की नियमित देखरेख और निगरानी",
    // <!-- Chemical Barrier Treatment -->
    Chemicalh:"रासायनिक सुरक्षा उपचार",
    Chemicalp:"अपनी संपत्ति के चारों ओर एक सुरक्षा अवरोध बनाएं, जो दीमकों को अंदर आने से रोके और पहले से मौजूद दीमकों को खत्म करे।",
    price1:"₹18 प्रति वर्ग फीट से शुरू",
    Chemical_servicel1:"इमारत के चारों ओर दीमक की दवा लगाना",
    Chemical_servicel2:"मिट्टी में दीमक से सुरक्षा के लिए क्षेत्र बनाना",
    Chemical_servicel3:"प्रवेश स्थानों और संवेदनशील इलाकों का इलाज",
    Chemical_servicel4:"नई तकनीकी दीमकनाशकों का उपयोग",
    Chemical_servicel5:"लंबे समय तक सुरक्षा, पर्यावरण पर कम प्रभाव के साथ",
    Termite_Inspectionh:"दीमक निरीक्षण और मूल्यांकन",
    Termite_Inspectionp:"हम दीमक की मौजूदा समस्याओं और आगे के जोखिमों की पहचान करते हैं, ताकि आपको पूरी जानकारी और सही इलाज का सुझाव मिल सके।",
    price2:"₹1,500 - ₹3,000 (उपचार के साथ निःशुल्क)",
    Termite_Inspectionl1:"संपत्ति के सभी खुले हिस्सों का निरीक्षण",
    Termite_Inspectionl2:"ज़रूरत के अनुसार सीलन और तापमान देखने वाले उपकरण लगाए जाते हैं।",
    Termite_Inspectionl3:"दीमक किस प्रकार की है और कितना फैलाव है, इसकी पहचान",
    Termite_Inspectionl4:"जो जगहें जोखिम भरी हो सकती हैं और जहां से दीमक आ सकती है, उनका मूल्यांकन",
    Termite_Inspectionl5:"उपचार योजना और खर्च की जानकारी के साथ विस्तार से रिपोर्ट",
    // <!-- Do's and Don'ts Section -->
    dos_donts_container:"दीमक नियंत्रण: क्या करें और क्या न करें",
     Dosl1:"नियमित रूप से पेशेवर दीमक निरीक्षण करवाएं (कम से कम साल में एक बार)।",
     Dosl2:"लकड़ी और कागज जैसी सामग्री को नींव से दूर रखें।",
     Dosl3:"पानी की पाइप्स और नालियों की समस्याओं को जल्दी ठीक करें।",
     Dosl4:"घर के निचले हिस्से और छत में हवा का सही प्रवाह रखें।",
     Dosl5:"नींव में होने वाली दरारों और खाली जगहों को भरें।",
     Dosl6:"गटर की सफाई रखें और नींव से पानी को सही तरीके से बहने दें।",
     Dosl7:"लकड़ी का सामान अपने घर से कम से कम 20 फीट दूर रखें।",
     Dosl8:"घर के पास से मृत पेड़ की जड़ें और तने हटा लें।",
     Dosl9:"अपने घर के लकड़ी के हिस्सों और मिट्टी के बीच कम से कम 6 इंच की दूरी बनाए रखें।",
     Dosl10:"निर्माण या सुधार के दौरान पहले से उपचार करने पर ध्यान दें।",
    //  Donts
    Dontsl1:"दीमक के लक्षणों (कीचड़, खोखली लकड़ी, फेंके हुए पंख) को नजरअंदाज न करें।",
    Dontsl2:"मिट्टी के पास निर्माण के लिए बिना उपचार की लकड़ी का उपयोग न करें।",
    Dontsl3:"अपनी नींव के पास पानी जमा होने न दें।",
    Dontsl4:"घर के पास लकड़ी का ढेर न रखें।",
    Dontsl5:"सही जानकारी के बिना DIY दीमक इलाज न करें।",
    Dontsl6:"सक्रिय दीमक को न छेड़े (यह उन्हें फैलने का कारण बन सकता है)।",
    Dontsl7:"निरीक्षण के दौरान लकड़ी की संरचनाओं को नजरअंदाज न करें।",
    Dontsl8:"अपने संपत्ति के पास लकड़ी और मिट्टी को आपस में न मिलाएं।",
    Dontsl9:"नींव की दीवारों के पास झाड़ियाँ न लगाएं।",
    Dontsl10:"किसी भी दिखने वाले नुकसान का इंतजार न करें, कार्रवाई पहले करें।",
    // <!-- CTA Section -->
    cta1h:"अपनी संपत्ति को दीमक से बचाएं।",
    cta1p:"अपनी संपत्ति को दीमक से सुरक्षित रखने के लिए हमारी दीमक नियंत्रण विशेषज्ञों से विस्तृत निरीक्षण और कस्टम उपचार योजना के लिए संपर्क करें।",
    WhatsApp2:"व्हाट्सएप पर मुफ्त निरीक्षण प्राप्त करें।"
    }
    }
